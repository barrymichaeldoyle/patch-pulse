...
describe('getUnknownArgs', () => {
  ...
  it('should ignore values for single-value flags', () => {
    const args = ['--package-manager', 'pnpm', '--project', 'packages/app'];
    const result = getUnknownArgs({
      args,
      validFlags,
  ...
  it('should still report invalid flags after single-value flags', () => {
    const args = ['--package-manager', 'pnpm', '--unknown'];
    const result = getUnknownArgs({
      args,
      validFlags,
      singleValueFlags: ['--package-manager', '--project'],
